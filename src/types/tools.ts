 ...
 *
 * `execute` is run by whoever executes tools: the browser, where the platform
 * takes them at `create`, and the backend itself where the transport returns
 * calls to answer. The signal is the turn's, and the backend supplies it
